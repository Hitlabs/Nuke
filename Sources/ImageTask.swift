...
open class ImageTask: Hashable {
     ...
     */
    @discardableResult open func completion(_ completion: ImageTaskCompletion) -> Self { fatalError("Abstract method") }
    ...
    @discardableResult open func resume() -> Self { fatalError("Abstract method") }
    ...
    @discardableResult open func cancel() -> Self { fatalError("Abstract method") }
}
